...
public class sigmasigmsboyArena extends SimulatedArena {
    ...
    public static final class sigmasigmsboyArenaObstacleMap extends FieldMap {
        ...
        public sigmasigmsboyArenaObstacleMap() {
            super();
 // left wall
 super.addBorderLine(new Translation2d(0, 4.51), new Translation2d(0, 8.2));

 // upper wall
 super.addBorderLine(new Translation2d(0, 8.12), new Translation2d(FIELD_WIDTH, 8.12));

 // righter wall
 super.addBorderLine(new Translation2d(FIELD_WIDTH, 1), new Translation2d(FIELD_WIDTH, 8.2));
 ...
 // blue state
 super.addRectangularObstacle(2, 2.5, new Pose2d(3.9, 2.8, new Rotation2d()));
